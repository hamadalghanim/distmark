...
class SellerServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.MakePurchase = channel.unary_unary(
                '/products.SellerService/MakePurchase',
                request_serializer=products__pb2.MakePurchaseRequest.SerializeToString,
                response_deserializer=products__pb2.MakePurchaseResponse.FromString,
                _registered_method=True)
...
def add_SellerServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'MakePurchase': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=products__pb2.MakePurchaseRequest.FromString,
                    response_serializer=products__pb2.MakePurchaseResponse.SerializeToString,
            ),
    }
...
class SellerService(object):
    ...
    def MakePurchase(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/products.SellerService/MakePurchase',
            products__pb2.MakePurchaseRequest.SerializeToString,
            products__pb2.MakePurchaseResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
